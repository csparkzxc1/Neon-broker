...
브라우저에서 바로 실행되는 시장 시뮬레이션. 캐릭터/스토리 없이 "트레이딩 자체로 재미있는가" 검증용.
...
스모크 테스트 (Node 18+, DOM 없이 30분 사이클 시뮬):
...
조작:
- 마우스: MARKET 행 클릭 → 자산 선택 / BUY / SELL / INSPECT
- 키보드: ↑↓ 자산 이동 / Space 매수 / S 매도 / I 인스펙트
